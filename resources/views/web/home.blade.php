        ...
        <div class="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div class="space-y-7" data-reveal>
                ...
                <h1 class="font-display text-5xl leading-[0.95] text-zinc-900 dark:text-[#f3ede4] md:text-6xl">
                    <span class="block md:whitespace-nowrap">Construímos websites e</span>
                    <span class="block md:whitespace-nowrap">aplicações modernas.</span>
                </h1>
                <p class="max-w-2xl text-lg text-[#4e576a] dark:text-[#e0e4eb]">A NBTech entrega experiências digitais de alto desempenho para empresas que querem crescer com tecnologia: web, mobile, plataformas e automação.</p>
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            @forelse ($featuredProjects as $project)
                <article class="group relative overflow-hidden rounded-lg border border-[#b8c1cf] bg-[#0a0e15] text-white dark:border-[#4e576a] dark:bg-[#212631]" data-reveal>
                    <img src="{{ $project->getFirstMediaUrl('cover') ?: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80' }}" alt="{{ $project->title }}" class="h-72 w-full object-cover transition duration-500 group-hover:scale-105" loading="lazy">
